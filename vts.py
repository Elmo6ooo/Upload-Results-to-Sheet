...
with open("/home/chienliu/Downloads/android-vts/results/2022.07.01_17.58.52/test_result_failures_suite.html") as fp:
    soup = BeautifulSoup(fp, 'html')

scopes = ["https://spreadsheets.google.com/feeds"]
credentials = ServiceAccountCredentials.from_json_keyfile_name("credentials.json", scopes)
client = gspread.authorize(credentials)
sheet = client.open_by_key("1eSp4g_2Z86MnZLUVljhMoDt1OgRIPeEV0KYMVq22zag").worksheet("TM-Seahawk-VTS")	
